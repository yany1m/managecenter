      ...
      <section id="main-content">
          <section class="wrapper" >
             ...
             <div class="panel-body">  
			   ...
			   <input  name="templateName" class="form-control" id="templateName" placeholder="Enter name">
			   </div>                                
               <div class="form-group">
               <label for="exampleInputEmail1">类型</label>
			   <input id="type" class="form-control" readonly="readonly" value="${type}">
			   </div>                                
	...
	<script>
	 ...
	 $("#submit").click(function(){
		...
		$.ajax({
				type:"post",
				dataType:"json",
				url:"/managecenter/addStatementTemplate",
				data:"name="+$("#templateName").val()+"&template="+template+"&type="+$("#type").val(),
