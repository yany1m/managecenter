...
<html lang="en">
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper" >
             ...
             <div class="panel-body">  
			   ...
			   <input  name="templateName" class="form-control" id="templateName" placeholder="Enter name" value=${statementTemplate.name}>
			   </div>                                                               
	...
	<script>
	  var codeEditor = null;
	  var treeEditor = null;
	  var json = ${statementTemplate.template};
	 ...
	 $("#submit").click(function(){
		...
		var template=JSON.stringify(codeEditor.get());
		$.ajax({
				type:"post",
				dataType:"json",
				url:"/managecenter/updateStatementTemplate",
				data:"name="+$("#templateName").val()+"&template="+template+"&id="+${statementTemplate.id},
